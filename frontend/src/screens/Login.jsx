...
export default function Login() {
  ...
  // Render Google's official Sign-In button — it reliably opens the account
  // chooser on click (One Tap can be silently suppressed). Re-renders on theme
  // change so it matches dark/light (filled_black vs outline).
  useEffect(() => {
  ...
  }, [handleGoogleCredential, googleClientId, theme]);
    ...
    <div className="bg-background text-on-background min-h-screen flex items-center justify-center overflow-hidden relative">
      ...
      <main className="w-full max-w-[440px] px-margin-mobile relative z-10">
        ...
        <div className="glass-card rounded-2xl p-unit-lg shadow-2xl login-enter">
          ...
          {/* Social — Google's official rendered button (reliable sign-in),
              themed to match light/dark and re-rendered on theme change. */}
          {googleClientId ? (
